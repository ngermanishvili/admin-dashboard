...
export default function KanbanTaskCard({ card, onDeleteTask, index }) {
  ...
  const mappedColumns = useSelector(state=>state.feature.currentSelection.mappedColumns)
  console.log(mappedColumns.includes(name))
      ...
      <Draggable draggableId={card.id} index={index}>
        {(provided) => (
          ...
          >
            ...
            <Checkbox
              disableRipple
              checked={mappedColumns.includes(name)}
